...
(function (factory) {
  ...
  function initMouseDetection(disable) {
    ...
    if (!mouseDetectionEnabled && !disable) {
      ...
      events[touchEvents ? "touchstart" : "pointerover pointermove pointerout MSPointerOver MSPointerMove MSPointerOut"] =
        function (e) {
  ...
  $.extend($.SmartMenus, {
    ...
    prototype: {
      ...
      itemActivate: function ($a, hideDeeperSubs) {
        ...
        if (
          level > 1 &&
          (!this.activatedItems[level - 2] || this.activatedItems[level - 2][0] != $ul.dataSM("parent-a")[0])
        ) {
          var self = this;
        ...
        if (!this.isCollapsible() || hideDeeperSubs) {
          this.menuHideSubMenus(
            !this.activatedItems[level - 1] || this.activatedItems[level - 1][0] != $a[0] ? level - 1 : level
          );
        }
      ...
      itemFocus: function (e) {
        ...
        if (
          ...
          (!this.activatedItems.length || this.activatedItems[this.activatedItems.length - 1][0] != $a[0])
        ) {
          ...
          if (
            ...
            $sub
              ...
              .css({
                ...
                width:
                  subW - (parseInt($sub.css("border-left-width")) || 0) - (parseInt($sub.css("border-right-width")) || 0),
          ...
          if (this.getClosestMenu(touchPoint.target) == $sub[0]) {
            ...
            if (/(start|down)$/i.test(e.type)) {
              ...
              if (data.touchY !== undefined) {
                if (
                  (data.momentum =
                    Math.pow(Math.abs(touchPoint.pageY - data.touchStartY) / (e.timeStamp - data.touchStartTime), 2) * 15)
                ) {
                  this.menuScrollStop($sub);
                  this.menuScroll($sub);
                  e.preventDefault();
