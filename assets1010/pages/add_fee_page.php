...
if (isset($_POST['btn_save'])) {
    $message = save_member_monthly_fee($_POST);
}
                    ...
                    <div class="box-body">
                        <?php if (isset($message)) { ?>
                            <h4 class="box-title text-info mb-0 "><i class="ti-user me-15"></i> <?php echo $message;
                                                                                                unset($message); ?></h4>
                        <?php } else { ?>
                            <h4 class="box-title text-info mb-0"><i class="ti-user me-15"></i> Monthly Fee Add</h4>
                        <?php } ?>
                        <hr class="my-15">
                        <div class="row">
                            ...
                            <div class="col-md-9 col-9">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="member_account_no">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-9">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" type="month" name="payment_month">
