		...
		<div class="content-wrapper">
			<div class="container">
				...
				if (isset($pages)) {
					...
					} elseif ($pages == "add_position") {
						include "pages/add_position_page.php";
					} elseif ($pages == "edit_member") {
						include "pages/edit_member_page.php";
					} elseif ($pages == "add_new_admin_user") {
						include "pages/add_new_admin_user_page.php";
					} elseif ($pages == "add_new_access_level") {
						include "pages/add_new_access_level_page.php";
					} elseif ($pages == "add_new_admin_user_partTwo") {
						include "pages/add_new_admin_user_partTwo_page.php";
					} elseif ($pages == "this_month_report") {
						include "pages/this_month_report_page.php";
					}
				} else {
