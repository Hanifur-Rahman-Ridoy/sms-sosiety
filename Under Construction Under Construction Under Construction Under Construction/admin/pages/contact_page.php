								...
								<div class="media-list media-list-divided media-list-hover">
									...
									<div class="media align-items-center">
									  ...
									  <a class="flexbox flex-grow gap-items text-truncate" href="#qv-user-details" data-toggle="quickview">
										<img class="avatar" src="assets/images/avatar/1.jpg" alt="...">

										<div class="media-body text-truncate">
										  <h6>Sophia</h6>
										  <small>
											<span>(123) 456-7980</span>
									...
									<div class="media align-items-center">
									  ...
									  <a class="flexbox flex-grow gap-items text-truncate" href="#qv-user-details" data-toggle="quickview">
										<img class="avatar" src="assets/images/avatar/2.jpg" alt="...">
									...
									<div class="media align-items-center">
									 ...
									 <div class="app-contact-star"> <a href="#"><i class="fa fa-star-o text-yellow"></i></a></div>
									  ...
									  <a class="flexbox flex-grow gap-items text-truncate" href="#qv-user-details" data-toggle="quickview">
										<img class="avatar" src="assets/images/avatar/3.jpg" alt="...">
									...
									<div class="media align-items-center">
									  ...
									  <a class="flexbox flex-grow gap-items text-truncate" href="#qv-user-details" data-toggle="quickview">
										<img class="avatar" src="assets/images/avatar/4.jpg" alt="...">
									...
									<div class="media align-items-center">
									  ...
									  <a class="flexbox flex-grow gap-items text-truncate" href="#qv-user-details" data-toggle="quickview">
										<img class="avatar" src="assets/images/avatar/default.jpg" alt="...">
									...
									<div class="media align-items-center">
									  ...
									  <a class="flexbox flex-grow gap-items text-truncate" href="#qv-user-details" data-toggle="quickview">
										<img class="avatar" src="assets/images/avatar/5.jpg" alt="...">
									...
									<div class="media align-items-center">
									  ...
									  <a class="flexbox flex-grow gap-items text-truncate" href="#qv-user-details" data-toggle="quickview">
										<img class="avatar" src="assets/images/avatar/6.jpg" alt="...">
									...
									<div class="media align-items-center">
									  ...
									  <a class="flexbox flex-grow gap-items text-truncate" href="#qv-user-details" data-toggle="quickview">
										<img class="avatar" src="assets/images/avatar/8.jpg" alt="...">
