        ...
        return this.each(function () {
          ...
          $.each(validatorNames, function (i, el) {
            ...
            $.each(settings.validatorTypes, function (validatorType, validatorTemplate) {
              ...
              if (
                !foundValidator &&
                $this.data("validation" + el + formatValidatorName(validatorTemplate.name)) !== undefined
              ) {
            ...
            function (e, params) {
              ...
              if (errorsFound.length) {
                ...
                if (settings.options.semanticallyStrict && errorsFound.length === 1) {
                  $helpBlock.html(
                    errorsFound[0] + (settings.options.prependExistingHelpBlock ? $helpBlock.data("original-contents") : "")
                  );
                } else {
                  $helpBlock.html(
                    '<ul role="alert"><li>' +
